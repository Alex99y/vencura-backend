...
router.get('/account/:address/balance', authenticate, accountsController.getAccountBalance)

router.get('/account/:address/history', authenticate, accountsController.getAccountHistory)
