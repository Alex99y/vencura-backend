...
export const authenticate: RequestHandler = async (req: Request, res: AuthenticatedResponse, next: NextFunction) => {
    ...
    if (!dynamicAuthService.validateAuthentication(token)) {
